...
project = u'xbob.ip.color'
import time
copyright = u'%s, Idiap Research Institute' % time.strftime('%Y')

# Grab the setup entry
distribution = pkg_resources.require('xbob.ip.color')[0]
...
#html_short_title = 'xbob_ip_color'
...
htmlhelp_basename = 'xbob_ip_color_doc'
...
latex_documents = [
  ('index', 'xbob_ip_color.tex', u'Bob Color Conversion Utilities',
...
man_pages = [
    ('index', 'xbob_ip_color', u'Bob Color Conversion Utilities', [u'Idiap Research Institute'], 1)
]
